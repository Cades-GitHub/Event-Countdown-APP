...
document.addEventListener("DOMContentLoaded", function () { // Event listener that triggers when the DOM content is fully loaded
    ...
    const autocomplete = new google.maps.places.Autocomplete(locationInput); // Initialize Google Places Autocomplete
    autocomplete.addListener("place_changed", function () { // Add event listener for place_changed event
